...
<div class="users">
	...
	<?php if (count($long)): ?>
	<?= __('and') ?> <?= html::anchor('#users', sprintf(__2('%d other', '%d others', count($long)), count($long)), array('class' => 'expander', 'title' => __('Show/hide'), 'onclick' => '$(".users .long").toggle("normal"); return false;')) ?>
	<div class="long">
	<?= implode(', ', $long) ?>
	</div>
	<?php endif; ?>
